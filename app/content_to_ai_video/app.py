...
from content_to_video_generator import ContentToVideoGenerator
...
def process_video_creation(job_id, content, output_filename):
    ...
    try:
        ...
        video_path = generator.generate_video(content, output_filename)
...
def serve_video(filename):
    """API endpoint to serve the generated video for preview"""
