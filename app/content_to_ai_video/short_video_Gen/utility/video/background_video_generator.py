...
import json
from app.content_to_ai_video.short_video_Gen.utility.utils import log_response,LOG_TYPE_PEXEL
load_dotenv()
...
def getBestVideo(query_string, orientation_landscape=True, used_vids=[]):
    ...
    print("Response from video search API:", vids)
    if 'videos' in vids:
        videos = vids['videos']
    else:
        print("Error: 'videos' key not found in response")
        return []  # Return an empty list if 'videos' key is missing
